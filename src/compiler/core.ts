...
namespace ts {
    ...
    export const supportedJavascriptExtensions: ReadonlyArray<Extension> = [Extension.Js, Extension.Js6, Extension.Jsx];
    ...
    const extensionsToRemove = [Extension.Dts, Extension.Ts, Extension.Js, Extension.Js6, Extension.Tsx, Extension.Jsx];
